...
private var controller : ThirdPersonController2;
...
function Awake ()
{
	...
	if (target)
	{
		controller = target.GetComponent(ThirdPersonController2);
	}
	
	if (!controller)
		Debug.Log("Please assign a target to the camera that has a Third Person Controller 2 script component.");
}
...
function LateUpdate () {
	...
	if (Input.GetButton("Fire22") && !isSnapping)
	{
...
@script AddComponentMenu ("Third Person Camera 2/Spring Follow Camera 2")