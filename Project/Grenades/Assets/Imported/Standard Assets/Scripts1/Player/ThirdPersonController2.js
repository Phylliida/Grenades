...
function ApplyGravity ()
{
	...
	{
		// Apply gravity
		var jumpButton = Input.GetButton("Jump2");
...
{
	// * When falling down we use controlledDescentGravity (only when holding down jump)
	var jumpButton = Input.GetButton("Jump22");
...
@script AddComponentMenu("Third Person Player 2/Third Person Controller 2")
