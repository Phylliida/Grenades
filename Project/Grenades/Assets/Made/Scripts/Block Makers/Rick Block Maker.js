...
private var arr1 = new Array ();
//private var arr2 = new Array ();
//private var arr3 = new Array ();
...
function Update () {
	/*if(arr1.length >= 1650 && arr != arr && arr != arr3){
		arr = arr2;
	}
	else{
		arr = arr1;	
	}
	if(arr2.length >= 1650 && arr != arr3 && arr != arr1{
		arr = arr3;
	}
	else{
		arr = arr3;	
	...
	if(arr3.length >= 1650 && arr != arr3 && arr != arr1{
		stopMaking = true;
	}
	else{
		stopMaking = false;
