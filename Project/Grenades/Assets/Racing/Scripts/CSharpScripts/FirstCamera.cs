...
public class FirstCamera : MonoBehaviour
{
	...
	void FixedUpdate()
	{
		...
		currentVelocity = Vector3.Lerp(prevVelocity, target.rigidbody.velocity, velocityDamping * Time.deltaTime);
		currentVelocity.y = 0;
	...
	void LateUpdate()
	{
		float speedFactor = Mathf.Clamp01(target.rigidbody.velocity.magnitude / 70.0f);
